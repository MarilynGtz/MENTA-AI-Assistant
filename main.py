"""Artificial intelligence Assistant Robot

Author: Marilyn Gutierrez Solis 
Email: marilyngtz.mgs@gmail.com
Last Edit: 
...
# random words list
hi_words = ['hi', 'hello', 'yes, your majesty', 'at your service', 'yes my lord']
bye_words = ['bye', 'arigato', 'hasta la vista baby']
